"""
Sublattice-Constrained Swap Operations (PyTorch)

For ABO3 perovskite structures with constrained swaps:
- B-site: Ti ↔ Fe only
- O-site: O ↔ VO only

Includes:
- Basic swap (Gumbel-Max sampling)
...
# =============================================================================
# Lazy Swap (with identity option)
# =============================================================================
